...
class EventType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('eventStart', 'datetime', array('label' => 'Départ'))
            ->add('eventEnd', 'datetime', array('label' => 'Retour'))
            ->add('eventBudget', 'money', array('label' => 'Budget') )
            ->add('eventComment', 'textarea', array('label' => 'Commentaire '))
            ->add('phEvent', 'file', array('label' => 'Photo d\'illustration', 'required' => false))
//            ->add('eventPhoto1')
//            ->add('eventPhoto2')
//            ->add('eventPhoto3')
//            ->add('eventPhoto4')
